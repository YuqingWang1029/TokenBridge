...
```
It is expected to achieve near-lossless reconstruction with metrics comparable to continuous VAE (FID Score: ~1.11, Inception Score: ~305 on Imagenet **training** dataset, FID Score: ~0.53 on validation).
